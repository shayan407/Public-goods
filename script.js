document.addEventListener('DOMContentLoaded', () => {
    function initializeProductSlideCounters() {
        ...
        slides.forEach(slide => {
            ...
            let counterDisplay = slide.querySelector('.product-number-add');
            ...
            if(btnAddToCart2){btnAddToCart2.addEventListener('click', (event) => {
            ...
            function updateAllDisplays() {
                ...
                if(btnAddToCart2 && btnAddToCart2.classList.contains('btn-active')) btnAddToCart2.classList.toggle('btn-active', counter > 0);
                if(counterDisplay) counterDisplay.classList.add('cart-active');
                if (counterDisplay && counterDisplay.classList.contains('cart-active')) {
                    setTimeout(() => {
                      counterDisplay.classList.remove('cart-active');
                    }, 300);
                }
            ...
            if(btnAddToCart2){btnAddToCart.addEventListener('click', (e) => {
                e.preventDefault();
